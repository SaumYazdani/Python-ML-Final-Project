def monthlyprediction(stocktick):
    ...
    data3["Predicted Adj Close"].to_csv(stocktick + "_predicted_monthly.csv")
    ...
    #plotting every 2nd tick in range 0,23 to prevent overlapping
    plt.xticks(np.arange(0, 23, 2))
    plt.xlabel('Date')
    #graph title set to stock ticker and time duration and details
    plt.title(stocktick + " Monthly Data: Actual = Blue and Cyan, Predicted = Orange and Green")
